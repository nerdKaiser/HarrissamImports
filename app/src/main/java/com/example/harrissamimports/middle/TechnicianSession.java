...
public class TechnicianSession {
    private static final String PREF_NAME = "TechnicianSession";
    ...
    public TechnicianSession(Context mContext) {
     ...
     * @param email
     */
    public void loginTech(String id, String fname, String lname, String gender, String contact, String address, String email,
...
//id, fname, lname, contact, email, address,buss_permit, buss_name, status, reg_date
     ...
     * @return user details
     */
    public EmployeeModel getTechDetails() {
