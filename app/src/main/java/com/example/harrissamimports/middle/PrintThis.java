...
import com.example.harrissamimports.Client.PaymentReceipt;

import java.io.FileOutputStream;
import java.io.IOException;

@RequiresApi(api = Build.VERSION_CODES.KITKAT)
public class PrintThis extends PrintDocumentAdapter {
    private PrintedPdfDocument mDoc;
    private Context mCon;
    private View mVie;

    public PrintThis(Context context, View view){
        mCon=context;
        mVie=view;
    }
