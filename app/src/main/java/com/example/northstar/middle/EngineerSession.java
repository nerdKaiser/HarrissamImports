...
public class EngineerSession {
    private static final String PREF_NAME = "EngineerSession";
    ...
    public EngineerSession(Context mContext) {
     ...
     * @param email
     */
    public void loginEng(String id, String fname, String lname, String gender, String contact, String address, String email,
...
//id, fname, lname, contact, email, address,buss_permit, buss_name, status, reg_date
     ...
     * @return user details
     */
    public EmployeeModel getEngDetails() {
