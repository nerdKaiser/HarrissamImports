...
public class FinanceSession {
    private static final String PREF_NAME = "FinanceSession";
    ...
    public FinanceSession(Context mContext) {
     ...
     * @param email
     */
    public void loginFina(String id, String fname, String lname, String gender, String contact, String address, String email,
...
//id, fname, lname, contact, email, address,buss_permit, buss_name, status, reg_date
     ...
     * @return user details
     */
    public EmployeeModel getFinaDetails() {
