...
import com.example.northstar.Client.ClientDash;
import com.example.northstar.Eng.EngDash;
import com.example.northstar.Fin.FinaDash;
import com.example.northstar.Mgr.MgrDash;
import com.example.northstar.Supp.SuppDas;
import com.example.northstar.Tech.Technician;
import com.example.northstar.middle.CustomerModel;
import com.example.northstar.middle.CustomerSession;
import com.example.northstar.middle.DataData;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("North Star Home");
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.developer:
                    ...
                    mydialog13.setMessage("NorthStart Mobile app\nwas developed by\nShem, KEMU student");
